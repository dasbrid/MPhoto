 ...
 */
public class CheckablePhotoGridActivity extends Activity implements CheckablePhotoGridAdapter.ISelectionChangedEventListener
...
*/
    ...
    public void onSelectionChanged(int numSelectedItems) {
        Log.v(TAG, Integer.toString(numSelectedItems) + " items selected");
        tvNumSelectedItems.setText(Integer.toString(numSelectedItems) + " items selected");
    }
